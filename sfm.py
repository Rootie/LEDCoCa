...
class SFM:
    ...
    def fix_points_by_length(self, coords):
        """
        code taken from light_fixer.py by Matt Parker
        https://github.com/standupmaths/xmastree2021
        """
    ...
    def fix_points(self):
        ...
        try:
            points_3D = self.fix_points_by_length(points_3D)
        except:
            pass
